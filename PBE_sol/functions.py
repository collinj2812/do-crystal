...
def WENO5(u_bar : ca.SX, u_in : ca.SX) -> ca.SX:
    ...
    for i in range(2,n-2):
        ...
        # smoothness indicators beta
        beta_1 = 13/12*(u_bar[i-2] - 2*u_bar[i-1] + u_bar[i])**2 + 1/4*(u_bar[i-2] - 4*u_bar[i-1] + 3*u_bar[i])**2
        beta_2 = 13/12*(u_bar[i-1] - 2*u_bar[i] + u_bar[i+1])**2 + 1/4*(u_bar[i-1] - u_bar[i+1])**2
        beta_3 = 13/12*(u_bar[i] - 2*u_bar[i+1] + u_bar[i+2])**2 + 1/4*(3*u_bar[i] - 4*u_bar[i+1] + u_bar[i+2])**2
